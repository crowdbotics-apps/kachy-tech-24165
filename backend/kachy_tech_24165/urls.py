"""kachy_tech_24165 URL Configuration
...
admin.site.site_header = "Kachy Tech"
admin.site.site_title = "Kachy Tech Admin Portal"
admin.site.index_title = "Kachy Tech Admin"

# swagger
api_info = openapi.Info(
    title="Kachy Tech API",
    default_version="v1",
    description="API documentation for Kachy Tech App",
)
